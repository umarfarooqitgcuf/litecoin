...
class CWalletDB : public BerkeleyBatch
{
public:
    std::map<std::string, std::reference_wrapper<BerkeleyDatabase>> m_databases;
    //auto it = m_databases.find(strFilename);
    CWalletDB(const std::string& strFilename, const char* pszMode = "r+", bool _fFlushOnClose = true) : BerkeleyBatch(m_databases.find(strFilename)->second.get(), pszMode, _fFlushOnClose)
    {
    }
    ...
    static bool Recover(BerkeleyBatch& dbenv, std::string filename, bool fOnlyKeys);
    static bool Recover(BerkeleyBatch& dbenv, std::string filename);
