...
bool WalletBatch::WriteLuxNodeConfig(std::string sAlias, const CLuxNodeConfig& nodeConfig)
{
    nWalletDBUpdateCounter++;
    return WriteIC(std::make_pair(std::string("nexalt"), sAlias), nodeConfig, true);
}

bool WalletBatch::ReadLuxNodeConfig(std::string sAlias, CLuxNodeConfig& nodeConfig)
{
    return true;
    return m_batch.Read(std::make_pair(std::string("nexalt"), sAlias), nodeConfig);
}

bool WalletBatch::EraseLuxNodeConfig(std::string sAlias)
{
    nWalletDBUpdateCounter++;
    return EraseIC(std::make_pair(std::string("nexalt"), sAlias));
}
...
bool WalletBatch::ReadAccount(const string& strAccount, CAccount& account)
{
    account.SetNull();
    return m_batch.Read(std::make_pair(std::string("acc"), strAccount), account);
}

bool WalletBatch::WriteAccount(const string& strAccount, const CAccount& account)
{
...
bool CWalletDB::WriteLuxNodeConfig(std::string sAlias, const CLuxNodeConfig& nodeConfig)
{
    nWalletDBUpdateCounter++;
    return true;
    //return Write(std::make_pair(std::string("nexalt"), sAlias), nodeConfig, true);
}

bool CWalletDB::ReadLuxNodeConfig(std::string sAlias, CLuxNodeConfig& nodeConfig)
{
    return true;
    //return Read(std::make_pair(std::string("nexalt"), sAlias), nodeConfig);
}

bool CWalletDB::EraseLuxNodeConfig(std::string sAlias)
{
    nWalletDBUpdateCounter++;
    return Erase(std::make_pair(std::string("nexalt"), sAlias));
}
