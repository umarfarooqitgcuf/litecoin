...
{
public:
    static const int MIN_PEER_PROTO_VERSION_DARK_SEND = MIN_PEER_PROTO_VERSION;
    bool fMasterNode = true;
    // clients entries
    ...
    CDarkSendPool()
    {
        ...
        cachedNumBlocks = 0;
        unitTest = false;
        CTransaction(txCollateral) = CTransaction();
        minBlockSpacing = 1;
        nDsqCount = 0;
        lastNewBlock = 0;
    ...
    void InitCollateralAddress(){
        ...
        strAddress = "MMfU9p4tWxXKcqANjsRg7JyDnnfSvMAr62";
    ...
    // get the denominations for a specific amount of xlt.
