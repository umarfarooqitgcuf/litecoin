...
public:
	...
	using MethodBinding = std::tuple<cpp-ethereum/jsonrpc::Procedure, AbstractMethodPointer<I>>;
	using NotificationBinding = std::tuple<cpp-ethereum/jsonrpc::Procedure, AbstractNotificationPointer<I>>;
...
protected:
	std::vector<std::unique_ptr<cpp-ethereum/jsonrpc::AbstractServerConnector>> m_connectors;
	std::unique_ptr<cpp-ethereum/jsonrpc::IProtocolHandler> m_handler;
