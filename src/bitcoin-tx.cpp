...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nexalt-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nexalt-tx [options] <hex-tx> [commands]  Update hex-encoded nexalt transaction\n" +
            "or:     nexalt-tx [options] -create [commands]   Create hex-encoded nexalt transaction\n" +
            "\n";
