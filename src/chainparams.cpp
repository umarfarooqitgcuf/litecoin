...
CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount &genesisReward) {
    const char *pszTimestamp = "BBC 02/02/2020 UK begins new chapter outside European Union";
...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 1594813280; // 07/15/2020 @ 11:41am (UTC)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1597881600; // 08/20/2020 @ 12:00am (UTC)

        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000004dcdb4f3024ab6ed");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0xa601455787cb65ffc325dda4751a99cf01d1567799ec4b04f45bb05f9ef0cbde"); //1683528
        ...
        vSeeds.emplace_back("dnsseed.nexalttools.com");
        vSeeds.emplace_back("dnsseed2.nexalttools.com");
        vSeeds.emplace_back("server1.nexalttools.com");
        ...
        checkpointData = {
                {
                        ...
                        {164540, uint256S("0x32db3935ab40a13c4875d4cf79f31fc7e2aea1096ce6548388e269ae40752bdf")},
                        {166540, uint256S("0x2e59d01536a87b9b5d2f613be14b0e45185815ff0d650488fbb3468a04bb820c")},
                        {169540, uint256S("0x38f0cad60d19144d828a22dfbc47f61ba616bfdf12cc03806e06375ea686d9bc")},
                }
        };
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x438b7e1c86f58b4e62e8cf2d0f9f256e3dddaebc5d1cc568e633a38e0db6c025"); //1174621
        ...
        /*vSeeds.emplace_back("testnet-seed.nexalttools.com");
        vSeeds.emplace_back("seed-b.nexalt.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        checkpointData = {
            {
                {0, uint256S("d4f99f684bca3f717ce78f6b75ef4d77a9228a91eb472fc09d647e9007195566")},
            }
        };
