...
#define SPORK_2_MAX_VALUE_DEFAULT                             10000        //500 xlt
...
public:
    ...
    bool UpdateSpork(CConnman* connman,int nSporkID, int64_t nValue);
    bool SetPrivKey(std::string strPrivKey);
    bool CheckSignature(CSporkMessage& spork);
    bool Sign(CSporkMessage& spork);
    void Relay(CConnman* connman, CSporkMessage& msg);
