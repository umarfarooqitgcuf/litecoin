...
const char * const BITCOIN_PID_FILENAME = "nexalt.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Nexalt";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Nexalt";
#else
    // Unix
    return pathRet / ".nexalt";
#endif
#endif
}
