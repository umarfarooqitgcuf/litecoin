...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 nexi per kB (0.00001 XLT). This is to prepare for dropping the minimum transaction fee to 0.1 nexi per kB (0.0001 XLT) in the next release.
