# Support for Output Descriptors in Nexalt Core

Since Nexalt Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `xlt1...` for mainnet or `txlt1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Nexalt's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Nexalt Core wallets, a convenience function `combo` is
