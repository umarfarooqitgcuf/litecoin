...
"""Verify that starting nexalt with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nexalt with -h for help text")
        ...
        self.log.info("Start nexalt with -version for version information")
        ...
        self.log.info("Start nexaltd with -fakearg to make sure it does not start")
