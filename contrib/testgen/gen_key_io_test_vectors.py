...
bech32_templates = [
  ...
  ('xlt',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('xlt',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('xlt',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('txlt',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('txlt',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('txlt',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rxlt',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rxlt',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rxlt', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('txlt',  17, 32, False, False, False),
  ('rxlt',  3,  1, False, False, False),
  ('xlt',   15, 41, False, False, False),
  ('txlt',  0, 16, False, False, False),
  ('rxlt',  0, 32, True,  False, False),
  ('xlt',   0, 16, True,  False, False),
  ('txlt',  0, 32, False, True,  False),
  ('rxlt',  0, 20, False, False, True)
]
